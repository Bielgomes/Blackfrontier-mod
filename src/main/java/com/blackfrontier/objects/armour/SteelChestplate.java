...
public class SteelChestplate extends ItemArmor implements IHasModel {
    public SteelChestplate(String name, ItemArmor.ArmorMaterial material, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
