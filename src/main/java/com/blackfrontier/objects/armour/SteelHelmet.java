...
public class SteelHelmet extends ItemArmor implements IHasModel {
    public SteelHelmet(String name, ItemArmor.ArmorMaterial material, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
